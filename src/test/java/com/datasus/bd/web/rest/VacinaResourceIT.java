...
class VacinaResourceIT {
    ...
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{idVacina}";
    ...
    void getAllVacinas() {
        ...
        webTestClient
            .get()
            .uri(ENTITY_API_URL + "?sort=idVacina,desc")
            ...
            .expectBody()
            .jsonPath("$.[*].idVacina")
            .value(hasItem(vacina.getIdVacina().intValue()))
            .jsonPath("$.[*].fabricante")
    ...
    void getVacina() {
        ...
        webTestClient
            .get()
            .uri(ENTITY_API_URL_ID, vacina.getIdVacina())
            .accept(MediaType.APPLICATION_JSON)
            .exchange()
            .expectStatus()
            .isOk()
            ...
            .expectBody()
            .jsonPath("$.idVacina")
            .value(is(vacina.getIdVacina().intValue()))
            .jsonPath("$.fabricante")
    ...
    void putNewVacina() throws Exception {
        ...
        // Update the vacina
        Vacina updatedVacina = vacinaRepository.findById(vacina.getIdVacina()).block();
        updatedVacina.fabricante(UPDATED_FABRICANTE).nomeVacina(UPDATED_NOME_VACINA);

        webTestClient
            .put()
            .uri(ENTITY_API_URL_ID, updatedVacina.getIdVacina())
            .contentType(MediaType.APPLICATION_JSON)
    ...
    void putNonExistingVacina() throws Exception {
        int databaseSizeBeforeUpdate = vacinaRepository.findAll().collectList().block().size();
        vacina.setIdVacina(count.incrementAndGet());
    ...
    void partialUpdateVacinaWithPatch() throws Exception {
        ...
        partialUpdatedVacina.setIdVacina(vacina.getIdVacina());

        partialUpdatedVacina.fabricante(UPDATED_FABRICANTE);

        webTestClient
            .patch()
            .uri(ENTITY_API_URL_ID, partialUpdatedVacina.getIdVacina())
