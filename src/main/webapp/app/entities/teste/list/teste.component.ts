...
export class TesteComponent implements OnInit {
  ...
  trackIdTeste(_index: number, item: ITeste): number {
    return item.idTeste!;
  }
  ...
  protected onSuccess(data: ITeste[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
