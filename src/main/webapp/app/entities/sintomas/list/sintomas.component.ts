...
export class SintomasComponent implements OnInit {
  ...
  trackIdSintomas(_index: number, item: ISintomas): number {
  ...
  protected sort(): string[] {
    ...
    if (this.predicate !== 'idSintomas') {
      result.push('idSintomas');
    }
    return result;
  }
  ...
  protected onSuccess(data: ISintomas[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
